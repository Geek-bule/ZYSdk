...
- (void)commonInit
{
    ...
    self.effect = ZYScrollViewEffectNone;
}

- (void)setEffect:(ZYScrollViewEffect)effect
{
    self->_effect = effect;
    
    switch (effect) {
        case ZYScrollViewEffectTranslation:
            self.angleRatio = 0.;
        ...
        case ZYScrollViewEffectDepth:
            ...
            self.translateY = 0.;
            break;
        case ZYScrollViewEffectCarousel:
            self.angleRatio = .5;
